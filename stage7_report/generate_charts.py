...
def generate_all_charts() -> None:
    ...
    a1_path = results_path / "a1_vwap_trajectory.csv"
    if a1_path.exists():
    ...
    a2_path = results_path / "a2_basis_divergence.csv"
    if a2_path.exists():
    ...
    a3_path = results_path / "a3_participant_profile.csv"
    if a3_path.exists():
    ...
    a4_path = results_path / "a4_algo_segmentation.csv"
    if a4_path.exists():
    ...
    a5_path = results_path / "a5_cancellation_patterns.csv"
    if a5_path.exists():
    ...
    a6_path = results_path / "a6_iceberg_detection.csv"
    if a6_path.exists():
    ...
    b1_path = results_path / "b1_spread_dynamics.csv"
    if b1_path.exists():
    ...
    b3_path = results_path / "b3_order_flow_imbalance.csv"
    if b3_path.exists():
    ...
    b4_path = results_path / "b4_price_impact.csv"
    if b4_path.exists():
    ...
    stat_path = results_path / "hypothesis_testing_summary.csv"
    if stat_path.exists():
